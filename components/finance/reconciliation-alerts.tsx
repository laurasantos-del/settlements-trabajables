  ...
  return (
    <div className="grid gap-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
        ...
        <KpiCard kpi={{ title: "Medio", value: alerts.filter((r) => r.category === "Medio").length, subtitle: showing, tone: "warning" }} />
        <KpiCard kpi={{ title: "Riesgo Alto", value: alerts.filter((r) => r.category === "Riesgo Alto").length, subtitle: showing, tone: "warning" }} />
