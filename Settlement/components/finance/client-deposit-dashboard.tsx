  ...
  return (
    <div className="grid gap-6">
      ...
      <div className="grid gap-4 xl:grid-cols-3">
        ...
        <KpiCard kpi={{ title: "Today Scheduled", value: groups.today.length, tone: "warning" }} />
        <KpiCard kpi={{ title: "Future Scheduled", value: groups.future.length, tone: "positive" }} />
      </div>
      <div className="card-pad"><h2 className="font-semibold text-white">Scheduled by bucket</h2><Bars data={[{ label: "Past", value: groups.past.length }, { label: "Today", value: groups.today.length }, { label: "Future", value: groups.future.length }]} /></div>
